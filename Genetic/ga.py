...
class GeneticSelectionCV(BaseEstimator, MetaEstimatorMixin, SelectorMixin):
    ...
    def _fit(self, X, y):
        ...
        toolbox.register("individual", tools.initRepeat, ## Repeats creator individual by toolbox . attr_bool times.
                         creator.Individual, toolbox.attr_bool, n=n_features) #each individual is a class inheriting from list and having fitness
                         # creator.individual will return a individual with minimized features by calling attr_bool n times
